...
class MascotaViewModel : ViewModel() {
    ...
    init {
        ...
        val mascota3 = Mascota(3, "Bella, Maga del pan con queso", Date(2019,3,2), "https://static.wikia.nocookie.net/gatopedia/images/a/af/Pop1.png/revision/latest?cb=20230105144717&path-prefix=es", 20.0)
